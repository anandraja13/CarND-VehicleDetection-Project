...
def find_cars(img, cspace, ystart, ystop, scale, svc, hog_channel, orient, pix_per_cell, cell_per_block, show_window_search=False):
    ...
    for xb in range(nxsteps):
        for yb in range(nysteps):
            ...
            if test_prediction == 1 or show_window_search:
